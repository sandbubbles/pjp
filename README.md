...
Because im really confused about the structure of the project I have a separe makefile just
for c++ things.
So while I'm working on the project, before I'll get to the llvm stuff I compile it with
that.
